# -*- coding: utf-8 -*-
"""
Created on Wed Jan 10 15:46:39 2024
...
parser.add_argument('--config', help='Path to config file', default='../configs/fine_tune.yaml')
...
src_train = SourceDataset(datasets.ImageFolder(root=cfg['target_train'],
                                     transform=transform_t))
src_val = SourceDataset(datasets.ImageFolder(root=cfg['target_val'],
                                     transform=transform_v))
target_train = TargetDataset(datasets.ImageFolder(root=cfg['src_train'],
                                     transform=transform_v))
target_val = TargetDataset(datasets.ImageFolder(root=cfg['src_val'],
                                     transform=transform_v))
